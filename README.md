...
[Why Nexus](#-why-nexus) · [Quick Start](#-quick-start) · [Typed Namespaces](#-typed-namespaces-the-killer-feature) · [Server-Side Rendering](#-server-side-rendering) · [Plugins](#-plugins)
...
- [Typed Namespaces](#-typed-namespaces-the-killer-feature)
- [Authentication](#-authentication)
  - [Sandbox Auth](#sandbox-auth-local-development)
  - [JWT Auth](#jwt-auth-static-or-refreshable)
  - [OIDC + JWKS](#oidc--jwks-production)
...
- [Server-Side Rendering](#-server-side-rendering)
  - [`createNexusServer`](#createnexusserver--the-unified-server-factory)
  - [Next.js Server Components](#nextjs-server-components--prefetch--hydrate)
  - [Server Actions](#server-actions)
  - [JWT Proxy Route Handler](#jwt-proxy-route-handler-b2b-pattern)
- [Plugins](#-plugins)
